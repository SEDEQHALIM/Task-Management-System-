    ...
    public partial class init : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_MemberWorkSpace", x => x.Id);
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.NoAction);
                    table.ForeignKey(
                        name: "FK_MemberWorkSpace_AspNetUsers_OwnerID",
                        column: x => x.OwnerID,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.NoAction);
                    table.ForeignKey(
                        name: "FK_MemberWorkSpace_WorkSpaces_WorkSpaceID",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_MessageChat_AspNetUsers_SenderId",
                        column: x => x.SenderId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.NoAction);
                    table.ForeignKey(
                        name: "FK_MessageChat_WorkSpaces_WorkSpaceId",
                        column: x => x.WorkSpaceId,
                        principalTable: "WorkSpaces",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.NoAction);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_MyTask_AspNetUsers_CreatedBy",
                        column: x => x.CreatedBy,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.NoAction);
                    table.ForeignKey(
                        name: "FK_MyTask_WorkSpaces_WorkSpaceId",
                        column: x => x.WorkSpaceId,
                        principalTable: "WorkSpaces",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.NoAction);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_MessageMentions_AspNetUsers_UserId",
                        column: x => x.UserId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.NoAction);
                    table.ForeignKey(
                        name: "FK_MessageMentions_MessageChat_MessageId",
                        column: x => x.MessageId,
                        principalTable: "MessageChat",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.NoAction);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.NoAction);
                    table.ForeignKey(
                        name: "FK_TaskAssignment_MyTask_TaskId",
                        column: x => x.TaskId,
                        principalTable: "MyTask",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.NoAction);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_MemberWorkSpace_OwnerID",
                table: "MemberWorkSpace",
                column: "OwnerID");

            migrationBuilder.CreateIndex(
                name: "IX_MemberWorkSpace_RoleID",
                table: "MemberWorkSpace",
                column: "RoleID");

            migrationBuilder.CreateIndex(
                name: "IX_MemberWorkSpace_WorkSpaceID",
                table: "MemberWorkSpace",
                column: "WorkSpaceID");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_MessageChat_WorkSpaceId",
                table: "MessageChat",
                column: "WorkSpaceId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_MyTask_CreatedBy",
                table: "MyTask",
                column: "CreatedBy");

            migrationBuilder.CreateIndex(
                name: "IX_MyTask_WorkSpaceId",
                table: "MyTask",
                column: "WorkSpaceId");
